...
export default function Externals() {
    ...
    useEffect(() => {
        try {
            axios
                .get(`${BASE_URL}/${cat_URL}/title/externals`)
                .then((data) => {
                    setExternals(data.data.data[0].products);
                })
                .finally(() => {
                    setLoading(false);
                });
    ...
    const externalsShow = externals.map((item, index) => {
        return (
        ...
        <div>
            ...
            <main className="main-products">
                {showDetails ? (
                    ...
                    <div>
                        <div>
                            <h1 className="main-title">Externals</h1>
                        </div>
                        <section style={{ marginTop: "30px" }}>
                            <div>
                                <h3 className="products-title">Mouses</h3>
