...
export default function Internals() {
    ...
    useEffect(() => {
        try {
            axios
                .get(`${BASE_URL}/${cat_URL}/title/internals`)
                .then((data) => {
                    setInternals(data.data.data[0].products);
                })
                .finally(() => {
                    setLoading(false);
                });
    ...
    const internalsShow = internals.map((item, index) => {
        return (
        ...
        <div>
            ...
            <main className="main-products">
                {showDetails ? (
                    ...
                    <div>
                        <div>
                            <h1 className="main-title">Internals</h1>
                        </div>
                        <section style={{ marginTop: "30px" }}>
                            <div>
                                <h3 className="products-title">Internals</h3>
